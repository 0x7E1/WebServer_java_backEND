package com.server.web_server.servlets;

import com.server.web_server.templater.PageGenerator;
...
public class AllRequestServlets extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        pageVariables.put("message", param);

        if (!param.equals("{}") && param.substring(1,4).equals("key"))
    ...
    private static Map<String, Object> createPageVariablesMap(HttpServletRequest request) {
        ...
        pageVariables.put("sessionId", request.getSession().getId() == null ? "null" : request.getSession().getId());
